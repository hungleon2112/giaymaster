...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            Đại lý mới <small>Danh sách</small>
        </h1>
    </div>
</div>
<!-- /.row -->
            ...
            <table data-toggle="table" data-search="true"   class="table table-hover" data-sort-order="desc" data-sort-name="name" data-click-to-select="true" >
                <thead>
                    <tr>
                        ...
                        <th data-field="all-branch"  data-sortable="true">Tổng đơn hàng</th>
                    </tr>
                </thead>
                <tbody>
                    @foreach($listUser as $p)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/agentBeginner/order/list/{{$p->Id}}">{{$p->Name}}</a>
                            </td>
                            <td>
                                {{$p->Phone}}
                            </td>
                            ...
                            <td>
                                {{number_format($p->TotalGiayDep)}}
                            </td>
                            <td>
                                {{number_format($p->TotalPhuKien)}}
                            </td>
                            <td>
