...
class OrderController extends \BaseController {
    ...
    public function SetDateFromTo($from_date, $to_date)
    {
        Session::put('from_date_order', $from_date);
        Session::put('to_date_order', $to_date);
    ...
    public function ListOrderBeginner($user_id){
        ...
        $from_date = Session::get('from_date_order');
        $to_date = Session::get('to_date_order');
